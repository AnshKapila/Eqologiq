...
export default function Page() {
  ...
  <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 py-4 bg-brand-base border-b border-brand-text/10 transition-all duration-300">
    <div class="max-w-[1400px] mx-auto px-6 md:px-12 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-10 absolute left-1/2 -translate-x-1/2">
        <a href="/shop/" class="text-sm font-body font-medium text-brand-primary">Shop</a>
  ...
  <div id="mobile-menu" class="fixed inset-0 z-[60] bg-brand-base transform translate-x-full transition-transform duration-500 ease-in-out flex flex-col">
    ...
    <div class="flex-1 flex flex-col justify-center px-12 gap-8">
      <a href="/shop/" class="text-4xl font-sans font-bold text-brand-primary">Shop</a>
  ...
  <main class="pt-20">
    ...
    <section class="bg-brand-base py-16 md:py-24 border-b border-brand-text/8">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12 reveal">
        <p class="kicker text-brand-primary mb-4 flex items-center gap-3"><span class="w-6 h-px bg-brand-primary"></span>The Collection</p>
        <h1 class="font-sans font-bold text-4xl md:text-5xl text-brand-text mb-4">Everything we make.</h1>
        <p class="font-body text-brand-text/60 text-lg max-w-lg">Plastic-free steel water bottles India-made, vegan oral care, and curated bundles. Every product built to perform and designed to outlast.</p>
      </div>
    </section>

    <!-- FILTER BAR -->
    <section class="bg-brand-base sticky top-[72px] z-40 py-4 border-b border-brand-text/8">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12 flex items-center gap-3 overflow-x-auto no-scrollbar">
        <button class="filter-btn active font-body font-medium text-sm px-6 py-2 rounded-full border border-brand-primary whitespace-nowrap" data-filter="all">All Products</button>
        <button class="filter-btn font-body font-medium text-sm px-6 py-2 rounded-full border border-brand-text/20 text-brand-text/70 whitespace-nowrap" data-filter="bottles">Bottles</button>
        <button class="filter-btn font-body font-medium text-sm px-6 py-2 rounded-full border border-brand-text/20 text-brand-text/70 whitespace-nowrap" data-filter="oral">Oral Care</button>
        <button class="filter-btn font-body font-medium text-sm px-6 py-2 rounded-full border border-brand-text/20 text-brand-text/70 whitespace-nowrap" data-filter="bundles">Bundles</button>
      </div>
    </section>

    <!-- PRODUCT GRID -->
    <section class="bg-brand-base py-16 md:py-24">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">

          <!-- P1: Steel Water Bottle 750ml — Bestseller -->
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="bottles">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/c_crop,x_0.000,y_0.033,w_1.000,h_0.747/v1777952844/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/g6uec6ksdecsgs8ybt9r.png" alt="Eqo Logiq Steel Water Bottle 750ml" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
              <span class="absolute top-3 left-3 px-2.5 py-1 text-[10px] font-sans font-bold uppercase tracking-wider rounded-full bg-brand-secondary text-brand-text">Bestseller</span>
            </div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-base text-brand-text mb-1">Steel Water Bottle - 750ml</h3>
              <p class="font-body text-xs text-brand-text/50 mb-3">Keeps cold for 24h • Food-grade steel • Zero plastic</p>
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹799</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
          </div>

          <!-- P2: Plastic Free Steel Bottle 1 Litre -->
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="bottles" style="transition-delay:60ms;">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1781025150/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/opdo2msffmbuadqb816m.png" alt="Eqo Logiq Plastic Free Steel Bottle 1 Litre" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            </div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-base text-brand-text mb-1">Plastic Free Steel Bottle | 1 Litre</h3>
              <p class="font-body text-xs text-brand-text/50 mb-3">Double wall • 12+ hrs insulation • No plastic</p>
              <div class="mt-auto flex items-baseline gap-2 mb-4">
          ...
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="bottles" style="transition-delay:120ms;">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-bottle.png" alt="Eqo Logiq Steel Flask 500ml" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            </div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-base text-brand-text mb-1">Steel Flask - 500ml</h3>
              <p class="font-body text-xs text-brand-text/50 mb-3">Compact • Cupholder-friendly • No-spill seal</p>
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹699</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
          ...
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="bottles" style="transition-delay:180ms;">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-bottle.png" alt="Eqo Logiq Kids Steel Bottle 400ml" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            </div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-base text-brand-text mb-1">Kids Steel Bottle - 400ml</h3>
              <p class="font-body text-xs text-brand-text/50 mb-3">Child-safe • Lightweight • BPA-free • Easy flip lid</p>
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹599</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
          ...
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="oral">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-brush.png" alt="Eqo Logiq Bamboo Toothbrush" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            </div>
            <div class="p-6 flex flex-col flex-1">
              ...
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹149</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
          ...
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="oral" style="transition-delay:60ms;">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-brush.png" alt="Eqo Logiq Bamboo Toothbrush Pack of 4" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
              <span class="absolute top-3 left-3 px-2.5 py-1 text-[10px] font-sans font-bold uppercase tracking-wider rounded-full bg-brand-secondary text-brand-text">Best value</span>
            </div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-base text-brand-text mb-1">Bamboo Toothbrush - Pack of 4</h3>
              <p class="font-body text-xs text-brand-text/50 mb-3">Family pack • Biodegradable • Plastic-free packaging</p>
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹499</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
          ...
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="oral" style="transition-delay:120ms;">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-cleaner.png" alt="Eqo Logiq Stainless Steel Tongue Scraper" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            </div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-base text-brand-text mb-1">Stainless Steel Tongue Scraper</h3>
              <p class="font-body text-xs text-brand-text/50 mb-3">Food-grade steel • Lasts for life • Zero plastic</p>
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹299</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
          ...
          <div onclick="window.location='/product.html'" class="group cursor-pointer reveal product-card bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col" data-cat="bundles" style="transition-delay:60ms;">
            <div class="relative aspect-square overflow-hidden bg-brand-surface">
              <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-bottle.png" alt="The Starter Switch Bundle" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
            ...
            <div class="p-6 flex flex-col flex-1">
              ...
              <div class="mt-auto flex items-baseline gap-2 mb-4">
                <span class="font-sans font-bold text-lg text-brand-text">₹1,199</span>
                <span class="text-xs text-brand-text/40 font-body">onwards</span>
              </div>
              <button onclick="event.stopPropagation();openCartDrawer();" class="w-full py-2 border-2 border-brand-primary text-brand-primary font-body font-medium text-sm rounded-lg text-center hover:bg-brand-primary hover:text-white transition-colors">Add to Cart</button>
            </div>
        ...
        <div class="text-center mt-16 reveal">
          <button class="px-10 py-4 border-2 border-brand-primary text-brand-primary font-sans font-bold rounded-xl hover:bg-brand-primary hover:text-white transition-all duration-300">Load More Products</button>
        </div>
      </div>
    </section>

    <!-- TRUST STRIP -->
    <section class="bg-brand-surface py-12 border-t border-brand-text/8">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div class="flex flex-col items-center gap-2">
            <i data-lucide="shield-check" class="w-6 h-6 text-brand-secondary"></i>
            <span class="font-body text-sm text-brand-text/70">100% Plastic-Free</span>
          </div>
          <div class="flex flex-col items-center gap-2">
            <i data-lucide="truck" class="w-6 h-6 text-brand-primary"></i>
            <span class="font-body text-sm text-brand-text/70">Free shipping above ₹1,500</span>
          </div>
          <div class="flex flex-col items-center gap-2">
            <i data-lucide="rotate-ccw" class="w-6 h-6 text-brand-primary"></i>
            <span class="font-body text-sm text-brand-text/70">Easy 7-day returns</span>
          </div>
          <div class="flex flex-col items-center gap-2">
            <i data-lucide="lock" class="w-6 h-6 text-brand-primary"></i>
            <span class="font-body text-sm text-brand-text/70">Secure checkout</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="max-w-[1400px] mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        <div class="md:col-span-1">
          ...
          <p class="font-body text-white/50 text-sm max-w-xs">Plastic-free steel bottles and daily essentials. No plastic in any product.</p>
        </div>
        <div>
          <h5 class="font-sans font-bold text-sm uppercase tracking-widest mb-6 text-white/80">Shop</h5>
          <ul class="space-y-4">
            <li><a href="/shop/" class="font-body text-white/50 hover:text-white transition-colors">Steel Bottles</a></li>
            <li><a href="/shop/" class="font-body text-white/50 hover:text-white transition-colors">Oral Care</a></li>
            <li><a href="/shop/" class="font-body text-white/50 hover:text-white transition-colors">Bundles</a></li>
            <li><a href="/contact/" class="font-body text-white/50 hover:text-white transition-colors">Corporate Gifting</a></li>
          </ul>
        </div>
        <div>
          <h5 class="font-sans font-bold text-sm uppercase tracking-widest mb-6 text-white/80">Company</h5>
          <ul class="space-y-4">
            <li><a href="/about/" class="font-body text-white/50 hover:text-white transition-colors">Our Story</a></li>
            <li><a href="/qrash-qourse/" class="font-body text-white/50 hover:text-white transition-colors">Impact Report</a></li>
            <li><a href="/blog/" class="font-body text-white/50 hover:text-white transition-colors">Blogs</a></li>
            <li><a href="/contact/" class="font-body text-white/50 hover:text-white transition-colors">Contact</a></li>
          </ul>
        </div>
        <div>
          ...
          <form class="flex border-b border-white/20 pb-2">
            ...
            <button type="submit" class="text-white hover:text-brand-primary transition-colors"><i data-lucide="arrow-right" class="w-5 h-5"></i></button>
          </form>
        </div>
      </div>
  ...
  <script>
    ...
    function navigateResults(dir){const items=searchResults.querySelectorAll('.search-result-item');if(!items.length)return;items.forEach(el=>el.classList.remove('bg-brand-surface'));activeIdx=(activeIdx+dir+items.length)%items.length;items[activeIdx].classList.add('bg-brand-surface');items[activeIdx].scrollIntoView({block:'nearest'});}
    document.getElementById('search-btn').addEventListener('click',openSearch);
    document.getElementById('search-close').addEventListener('click',closeSearch);
    searchModal.addEventListener('click',e=>{if(e.target===searchModal)closeSearch();});
    searchInput.addEventListener('input',e=>renderResults(e.target.value));
    searchInput.addEventListener('keydown',e=>{if(e.key==='ArrowDown'){e.preventDefault();navigateResults(1);}else if(e.key==='ArrowUp'){e.preventDefault();navigateResults(-1);}else if(e.key==='Enter'){const items=searchResults.querySelectorAll('.search-result-item');if(activeIdx>=0&&items[activeIdx])items[activeIdx].click();}else if(e.key==='Escape')closeSearch();});
