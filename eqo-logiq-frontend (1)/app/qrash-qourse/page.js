...
export default function Page() {
  ...
  <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 py-4 bg-brand-base border-b border-brand-text/10 transition-all duration-300">
    <div class="max-w-[1400px] mx-auto px-6 md:px-12 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-10 absolute left-1/2 -translate-x-1/2">
        ...
        <a href="/qrash-qourse/" class="text-sm font-body font-medium text-brand-primary">Impact</a>
  ...
  <div id="mobile-menu" class="fixed inset-0 z-[60] bg-brand-base transform translate-x-full transition-transform duration-500 ease-in-out flex flex-col">
    ...
    <div class="flex-1 flex flex-col justify-center px-12 gap-8">
      ...
      <a href="/qrash-qourse/" class="text-4xl font-sans font-bold text-brand-primary">Impact</a>
  ...
  <main class="pt-20">
    ...
    <!-- PAGE HEADER -->
    <section class="relative overflow-hidden min-h-[55vh] flex items-end" style="background:#0D1535;">
      <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_1600,c_fill,g_auto/v1778268332/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/p791vnujzavosqtj0yla.png" alt="" class="absolute inset-0 w-full h-full object-cover opacity-40" aria-hidden="true">
      <div class="absolute inset-0" style="background:linear-gradient(to top,rgba(13,21,53,0.90) 0%,rgba(13,21,53,0.20) 100%);"></div>
      <div class="relative max-w-[1400px] mx-auto px-6 md:px-12 py-20 w-full">
        <div class="reveal">
          <p class="kicker mb-6 flex items-center gap-3" style="color:rgba(147,185,255,0.85);"><span class="w-6 h-px" style="background:rgba(147,185,255,0.85);"></span>Knowledge Base</p>
          <h1 class="font-sans font-bold text-white mb-6 leading-[1.05]" style="font-size:clamp(2.5rem,5vw,4.5rem);">The Qrash Qourse.<br>What you use every day, explained.</h1>
          <p class="font-body mb-16 max-w-[600px]" style="color:rgba(255,255,255,0.65);font-size:18px;line-height:1.7;">Material science, environmental data, and documented health research relevant to plastic-free daily essentials. Sources linked where available.</p>
        </div>
        <!-- Stat callouts -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 reveal" style="transition-delay:100ms;">
          <div>
            <p class="font-sans font-bold mb-2" style="font-size:clamp(2.5rem,4vw,3.5rem);line-height:1;color:#006B96;">400+</p>
            <p class="font-body text-sm" style="color:rgba(255,255,255,0.55);">Plastic bottles per Indian household per year</p>
          </div>
          <div>
            <p class="font-sans font-bold mb-2" style="font-size:clamp(2.5rem,4vw,3.5rem);line-height:1;color:#006B96;">8.76kg</p>
            <p class="font-body text-sm" style="color:rgba(255,255,255,0.55);">Plastic waste from water consumption annually per household</p>
          </div>
          <div>
            <p class="font-sans font-bold mb-2" style="font-size:clamp(2.5rem,4vw,3.5rem);line-height:1;color:#006B96;">400 years</p>
            <p class="font-body text-sm" style="color:rgba(255,255,255,0.55);">PET bottle decomposition time in landfill</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="w-full py-24 md:py-40" style="background:#F7F5F0;">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12">
        <div class="reveal mb-12">
          <p class="kicker mb-4 flex items-center gap-3" style="color:#006B96;"><span class="w-6 h-px" style="background:#006B96;"></span>Why Material Comes First</p>
          <h2 class="font-sans font-bold text-brand-text leading-tight" style="font-size:clamp(2rem,3.5vw,2.75rem);">What the material is and what it means for daily use.</h2>
        </div>
        <div class="flex flex-col md:flex-row gap-12 md:gap-16 items-start">
          <!-- Left: text -->
          <div class="w-full md:w-[55%] reveal">
            <div class="mb-10">
              <p class="font-sans font-bold text-brand-text text-lg mb-3">The problem with plastic.</p>
              <p class="font-body text-brand-text/70 leading-relaxed text-base">Plastic leaches chemical compounds into whatever it contains, particularly under heat, UV exposure, and repeated use. BPA is the most discussed but it is far from the only compound of concern. The science on microplastic ingestion through water containers is documented.</p>
            </div>
            <div class="mb-10">
              <p class="font-sans font-bold text-brand-text text-lg mb-3">Why stainless steel is different.</p>
            ...
            <div>
              <p class="font-sans font-bold text-brand-text text-lg mb-3">What food-grade actually means.</p>
              ...
              <p class="font-body text-brand-text/70 leading-relaxed text-base mt-4">Eqo Logiq products have been independently tested to verify the 304 food-grade steel composition. The full test report is available on request. Contact hello@eqologiq.in to receive a copy.</p>
            </div>
          </div>
          <!-- Right: graphic -->
          <div class="w-full md:w-[45%] reveal" style="transition-delay:80ms;">
            <div class="rounded-2xl overflow-hidden" style="background:#EAE6DF;">
              <img src="https://static.kite.ai/image/upload/v1779973694/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/brmwveksy2kh8fyje8au.png" alt="Material science graphic: plastic vs stainless steel" class="w-full h-auto" onerror="this.outerHTML='<div style=\'min-height:360px;display:flex;align-items:center;justify-content:center;\'><p style=\'color:rgba(34,34,34,0.3);font-family:Inter,sans-serif;font-size:14px;text-align:center;padding:2rem;\'>Material Science Graphic</p></div>'">
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="w-full py-24 md:py-40" style="background:#F2EFE8;">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12">
        <div class="reveal mb-8">
          <p class="kicker mb-4 flex items-center gap-3" style="color:#006B96;"><span class="w-6 h-px" style="background:#006B96;"></span>What the Research Shows</p>
          <h2 class="font-sans font-bold text-brand-text leading-tight" style="font-size:clamp(2rem,3.5vw,2.75rem);">Documented health research on plastic exposure.</h2>
        </div>
        <p class="font-body text-brand-text/70 leading-relaxed mb-14 reveal" style="font-size:17px;max-width:720px;">Several decades of peer-reviewed research have documented the effects of plastic exposure on human health. They are published studies from institutions including the National Institutes of Health, the World Health Organization, and universities across India, Europe, and the United States. The following is a summary of published research.</p>
        <!-- Health graphic full width -->
        <div class="reveal mb-14 flex justify-center">
          <div class="rounded-2xl overflow-hidden w-full" style="max-width:900px;background:#EAE6DF;">
            <img src="https://static.kite.ai/image/upload/v1779973693/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/dederfvwn02qgnm5vtis.png" alt="Health impact research graphic" class="w-full" onerror="this.outerHTML='<div style=\'min-height:300px;display:flex;align-items:center;justify-content:center;\'><p style=\'color:rgba(34,34,34,0.3);font-family:Inter,sans-serif;font-size:14px;text-align:center;padding:2rem;\'>Health Research Graphic</p></div>'">
          </div>
        </div>
        <!-- Impact cards -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          <div class="bg-white rounded-xl p-6 reveal impact-card impact-card-hormone">
            <div class="w-8 h-8 rounded-full flex items-center justify-center mb-5" style="background:rgba(0,107,150,0.08);">
              <i data-lucide="activity" class="w-4 h-4" style="color:#006B96;"></i>
            </div>
            <p class="font-sans font-bold text-brand-text text-base mb-2">Hormone Disruption</p>
            <p class="font-body text-brand-text/60 text-sm leading-relaxed">Compounds including BPA, BPS, and phthalates found in plastic mimic oestrogen and interfere with endocrine function. This has been observed at exposure levels consistent with normal daily use.</p>
          </div>
          <div class="bg-white rounded-xl p-6 reveal impact-card impact-card-neuro" style="transition-delay:60ms;">
            <div class="w-8 h-8 rounded-full flex items-center justify-center mb-5" style="background:rgba(0,107,150,0.08);">
              <i data-lucide="cpu" class="w-4 h-4" style="color:#006B96;"></i>
            </div>
            <p class="font-sans font-bold text-brand-text text-base mb-2">Neurological Impact</p>
            <p class="font-body text-brand-text/60 text-sm leading-relaxed">Studies in rodent models and emerging human research suggest links between plastic chemical exposure and neurological development, particularly in foetal and early childhood stages.</p>
          </div>
          <div class="bg-white rounded-xl p-6 reveal impact-card impact-card-reproductive" style="transition-delay:120ms;">
            <div class="w-8 h-8 rounded-full flex items-center justify-center mb-5" style="background:rgba(0,107,150,0.08);">
              <i data-lucide="heart" class="w-4 h-4" style="color:#006B96;"></i>
            </div>
            <p class="font-sans font-bold text-brand-text text-base mb-2">Reproductive Health</p>
            <p class="font-body text-brand-text/60 text-sm leading-relaxed">Endocrine-disrupting compounds from plastics have been associated with reduced fertility markers in both male and female subjects across multiple independent studies.</p>
          </div>
          <div class="bg-white rounded-xl p-6 reveal impact-card impact-card-cellular" style="transition-delay:180ms;">
            <div class="w-8 h-8 rounded-full flex items-center justify-center mb-5" style="background:rgba(0,107,150,0.08);">
              <i data-lucide="shield-off" class="w-4 h-4" style="color:#006B96;"></i>
            </div>
            <p class="font-sans font-bold text-brand-text text-base mb-2">Cellular Exposure</p>
            <p class="font-body text-brand-text/60 text-sm leading-relaxed">Microplastics have been detected in human blood, lung tissue, and breast milk in studies published between 2021 and 2023. Long-term cellular implications are an active area of research.</p>
          </div>
        </div>
        <p class="text-center font-body" style="font-size:13px;color:rgba(34,34,34,0.40);">This section summarises published peer-reviewed research. Eqo Logiq does not make medical claims. Links to source studies available on request.</p>
        <p class="text-center font-body mt-4" style="font-size:13px;color:rgba(34,34,34,0.40);">Source studies available on request via hello@eqologiq.in</p>
      </div>
    </section>

    <!-- SECTION THREE: THE LIFECYCLE -->
    <section class="w-full py-24 md:py-40" style="background:#1C1C1C;">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12">
        <div class="reveal mb-14">
          <p class="kicker mb-4 flex items-center gap-3" style="color:rgba(147,185,255,0.85);"><span class="w-6 h-px" style="background:rgba(147,185,255,0.85);"></span>The Numbers</p>
          <h2 class="font-sans font-bold text-white leading-tight" style="font-size:clamp(2rem,3.5vw,2.75rem);">Product lifecycle - plastic versus steel.</h2>
        </div>
        <div class="flex flex-col md:flex-row gap-12 md:gap-16 items-start">
          <!-- Left: lifecycle graphic -->
          <div class="w-full md:w-1/2 reveal">
            <div class="rounded-2xl overflow-hidden" style="background:#2A2A2A;">
              <img src="https://static.kite.ai/image/upload/v1779973693/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/sdyf0memcx5beapwiqtt.png" alt="Lifecycle comparison graphic: plastic bottle vs Eqo Logiq bottle" class="w-full h-auto" onerror="this.outerHTML='<div style=\'min-height:360px;display:flex;align-items:center;justify-content:center;\'><p style=\'color:rgba(255,255,255,0.3);font-family:Inter,sans-serif;font-size:14px;text-align:center;padding:2rem;\'>Lifecycle Comparison Graphic</p></div>'">
            </div>
          </div>
          <!-- Right: timeline -->
          <div class="w-full md:w-1/2 reveal" style="transition-delay:80ms;">
            <div class="space-y-0">
              <div class="flex gap-8">
                <div class="flex flex-col items-center">
                  <div class="w-10 h-10 rounded-full bg-brand-primary flex items-center justify-center flex-shrink-0 text-white font-sans font-bold text-sm">1</div>
                  <div class="w-px flex-1 my-2" style="background:rgba(255,255,255,0.12);"></div>
                </div>
                <div class="pb-10">
                  <p class="font-sans font-bold text-white text-xl leading-tight mb-2">2 minutes.</p>
                  <p class="font-body text-sm" style="color:rgba(255,255,255,0.60);">The average time a single-use plastic bottle is actively used before being discarded.</p>
                </div>
              </div>
              <div class="flex gap-8">
                <div class="flex flex-col items-center">
                  <div class="w-10 h-10 rounded-full bg-brand-primary flex items-center justify-center flex-shrink-0 text-white font-sans font-bold text-sm">2</div>
                  <div class="w-px flex-1 my-2" style="background:rgba(255,255,255,0.12);"></div>
                </div>
                <div class="pb-10">
                  <p class="font-sans font-bold text-white text-xl leading-tight mb-2">450 years.</p>
                  <p class="font-body text-sm" style="color:rgba(255,255,255,0.60);">The minimum time a PET plastic bottle takes to decompose in landfill conditions.</p>
                </div>
              </div>
              <div class="flex gap-8">
                <div class="flex flex-col items-center">
                  <div class="w-10 h-10 rounded-full bg-brand-primary flex items-center justify-center flex-shrink-0 text-white font-sans font-bold text-sm">3</div>
                  <div class="w-px flex-1 my-2" style="background:rgba(255,255,255,0.12);"></div>
                </div>
                <div class="pb-10">
                  <p class="font-sans font-bold text-white text-xl leading-tight mb-2">10 years.</p>
                  <p class="font-body text-sm" style="color:rgba(255,255,255,0.60);">The designed minimum lifespan of an Eqo Logiq steel bottle under normal daily use.</p>
                </div>
              </div>
              <div class="flex gap-8">
                <div class="flex flex-col items-center">
                  <div class="w-10 h-10 rounded-full bg-brand-primary flex items-center justify-center flex-shrink-0 text-white font-sans font-bold text-sm">4</div>
                </div>
                <div class="pb-4">
                  <p class="font-sans font-bold text-white text-xl leading-tight mb-2">3,650.</p>
                  <p class="font-body text-sm" style="color:rgba(255,255,255,0.60);">The approximate number of single-use bottles one Eqo Logiq bottle displaces over its lifetime.</p>
                </div>
              </div>
            </div>
            <p class="font-body mt-10 pt-8 border-t" style="color:rgba(255,255,255,0.80);font-size:16px;font-weight:500;border-color:rgba(255,255,255,0.12);">These figures are based on standard product lifecycle data.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-brand-primary py-28 text-center px-6 reveal">
      <div class="max-w-[800px] mx-auto">
        <p class="kicker mb-6 flex items-center justify-center gap-3" style="color:rgba(255,255,255,0.60);"><span class="w-6 h-px" style="background:rgba(255,255,255,0.40);"></span>Our Position<span class="w-6 h-px" style="background:rgba(255,255,255,0.40);"></span></p>
        <h2 class="font-sans font-bold text-white leading-[1.05] mb-8" style="font-size:clamp(1.75rem,3.5vw,3rem);">At the junction of personal health and environmental responsibility, material selection comes first.</h2>
        <p class="font-body text-white/70 mb-10" style="font-size:17px;line-height:1.8;">Every Eqo Logiq product begins with a material decision. The environmental outcome follows from that decision. The two are not separate considerations.</p>
        <hr style="border-color:rgba(255,255,255,0.20);margin-bottom:2.5rem;">
        <div class="grid grid-cols-2 gap-8 md:gap-16">
          <div>
            <p class="font-sans font-bold text-white mb-2" style="font-size:clamp(2rem,4vw,3rem);line-height:1;">Zero</p>
            <p class="font-body text-sm" style="color:rgba(255,255,255,0.60);">Plastic in any Eqo Logiq product. By design, not compromise.</p>
          </div>
          <div>
            <p class="font-sans font-bold text-white mb-2" style="font-size:clamp(2rem,4vw,3rem);line-height:1;">One</p>
            <p class="font-body text-sm" style="color:rgba(255,255,255,0.60);">Question we ask before every material decision. Is this the best it can be?</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="w-full py-24 md:py-32 text-center" style="background:#F7F5F0;">
      <div class="max-w-[600px] mx-auto px-6 md:px-12 reveal">
        <p class="kicker mb-6 flex items-center justify-center gap-3" style="color:#006B96;"><span class="w-6 h-px" style="background:#006B96;"></span>Ready to Switch<span class="w-6 h-px" style="background:#006B96;"></span></p>
        <h2 class="font-sans font-bold text-brand-text mb-5" style="font-size:clamp(1.75rem,3vw,2.5rem);line-height:1.1;">See the products.</h2>
        <p class="font-body text-brand-text/60 mb-10" style="font-size:16px;line-height:1.7;">Plastic-free steel bottles and daily essentials. Free shipping above ₹1,500.</p>
        <a href="/shop/" class="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-full font-sans font-bold text-white transition-colors mb-6" style="background:#006B96;" onmouseover="this.style.background='#005580'" onmouseout="this.style.background='#006B96'">Shop the collection.</a>
        <br>
        <a href="/about/" class="font-body font-medium text-sm hover:underline" style="color:#006B96;">Read our story →</a>
      </div>
    </section>

    <!-- Internal link: Journal -->
    <section class="w-full py-10 border-t border-brand-text/8" style="background:#F7F5F0;">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12 text-center">
        <p class="font-body text-brand-text/60 text-sm">More reading on plastic-free living: <a href="/blog/" class="text-brand-primary font-medium hover:underline">Journal</a></p>
      </div>
    </section>
