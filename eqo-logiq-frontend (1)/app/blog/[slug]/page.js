...
export default function Page() {
  ...
  <main class="pt-20">
    <!-- BREADCRUMB -->
    <div class="max-w-[780px] mx-auto px-6 md:px-12 pt-8 pb-4">
      <nav class="flex items-center gap-2 font-body text-sm text-brand-text/40">
        ...
        <a href="/blog/" class="hover:text-brand-primary transition-colors">Blogs</a>
        <i data-lucide="chevron-right" class="w-3 h-3"></i>
        <span class="text-brand-text/70 truncate">The math behind switching</span>
      </nav>
    </div>

    <!-- POST HEADER -->
    <article class="max-w-[780px] mx-auto px-6 md:px-12 pt-8 pb-20">
      <div class="reveal">
        <span class="inline-block px-3 py-1 rounded-full text-xs font-sans font-bold uppercase tracking-wider bg-brand-primary/10 text-brand-primary mb-6">Impact</span>
        <h1 class="font-sans font-bold text-3xl md:text-4xl text-brand-text mb-6 leading-[1.15]">The math behind switching to a reusable bottle, and why it's simpler than you think.</h1>
        <div class="w-full aspect-[16/9] rounded-2xl overflow-hidden bg-brand-surface mb-10">
          <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_1200,c_fill,g_auto/v1777841241/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/feature-lifestyle.png" alt="Eqo Logiq Core Bottle in use" class="w-full h-full object-cover">
        </div>
      </div>
      ...
      <div class="mt-16 pt-10 border-t border-brand-text/8 reveal">
        <p class="kicker text-brand-text/40 mb-6">What we recommend</p>
        <div class="flex flex-col sm:flex-row gap-6 items-center bg-white rounded-2xl p-6 shadow-[0_2px_16px_rgba(34,34,34,0.07)]">
          <div class="w-24 h-24 bg-brand-surface rounded-xl flex-shrink-0 overflow-hidden">
            <img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_200/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-bottle.png" alt="Core Bottle" class="w-full h-full object-cover">
          </div>
          <div class="flex-1">
            <h3 class="font-sans font-bold text-lg text-brand-text mb-1">The Core Bottle</h3>
            <p class="font-body text-sm text-brand-text/60 mb-1">Matte Cobalt • 750ml • Food-grade stainless steel</p>
            <div class="flex items-baseline gap-2"><span class="font-sans font-bold text-xl text-brand-text">₹1,299</span><span class="text-sm text-brand-text/35 line-through font-body">₹1,799</span></div>
          </div>
          <a href="/product/" class="inline-flex items-center justify-center px-6 py-3 bg-brand-primary text-white font-sans font-bold text-sm rounded-xl hover:bg-blue-700 transition-colors whitespace-nowrap">Shop this</a>
        </div>
      </div>
    </article>
  </main>
