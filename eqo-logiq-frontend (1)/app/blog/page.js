export const metadata = {
  ...
  alternates: { canonical: `https://eqologiq.kite.space/blog.html` },
  openGraph: {
    title: `Journal | Eqo Logiq Blog on Plastic-Free Living`,
    description: `Short reads. Real thoughts. The Eqo Logiq journal on plastic-free products, materials science, and daily life without plastic.`,
  ...
  <main class="pt-20">
    <section class="bg-brand-base py-16 md:py-24 border-b border-brand-text/8">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12 reveal">
        <p class="kicker text-brand-primary mb-4 flex items-center gap-3"><span class="w-6 h-px bg-brand-primary"></span>Blogs</p>
        <h1 class="font-sans font-bold text-4xl md:text-5xl text-brand-text mb-4">Blogs.</h1>
        <p class="font-body text-brand-text/60 text-lg">Short reads. Real thoughts.</p>
      </div>
    </section>

    <section class="bg-brand-base py-16 md:py-28">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">

          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col reveal group">
            <div class="aspect-[4/3] overflow-hidden bg-brand-surface"><img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/proof-1.png" alt="Person using an Eqo Logiq steel bottle" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"></div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-lg text-brand-text mb-3 leading-tight">Five things I noticed after switching from plastic to steel for six months.</h3>
              <p class="font-body text-sm text-brand-text/60 leading-relaxed mb-6 flex-1">Water tastes different. Not better, exactly. Just neutral. Like how it should taste. That was the first thing I noticed, and it was unexpected.</p>
              <a href="/blog-post/" class="font-body text-sm font-medium text-brand-primary hover:underline inline-flex items-center gap-1">Read more <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></a>
            </div>
          </div>

          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col reveal group" style="transition-delay:80ms;">
            <div class="aspect-[4/3] overflow-hidden bg-brand-surface"><img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/proof-2.png" alt="Steel water bottle in a gym bag" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"></div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-lg text-brand-text mb-3 leading-tight">What I actually keep in my gym bag now, and why the bottle matters more than I expected.</h3>
              <p class="font-body text-sm text-brand-text/60 leading-relaxed mb-6 flex-1">Every litre you drink from plastic during a workout is a litre that's spent time in a container that wasn't designed for heat. Here's what I use instead.</p>
              <a href="/blog-post/" class="font-body text-sm font-medium text-brand-primary hover:underline inline-flex items-center gap-1">Read more <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></a>
            </div>
          </div>

          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col reveal group" style="transition-delay:160ms;">
            <div class="aspect-[4/3] overflow-hidden bg-brand-surface"><img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/v1777841241/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/feature-lifestyle.png" alt="Eqo Logiq Core Bottle in everyday lifestyle use" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"></div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-lg text-brand-text mb-3 leading-tight">The honest review: I gave our Core Bottle to someone who buys cheap plastics and this is what they said.</h3>
              <p class="font-body text-sm text-brand-text/60 leading-relaxed mb-6 flex-1">I handed it to my flatmate without any sales pitch. Three weeks later, she asked where to buy one for her sister.</p>
              <a href="/blog-post/" class="font-body text-sm font-medium text-brand-primary hover:underline inline-flex items-center gap-1">Read more <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></a>
            </div>
          </div>

          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col reveal group">
            <div class="aspect-[4/3] overflow-hidden bg-brand-surface"><img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-brush.png" alt="Eqo Logiq bamboo toothbrush with vegan bristles" class="w-full h-full object-cover"></div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-lg text-brand-text mb-3 leading-tight">Bamboo toothbrushes: the good, the bad, and the bristle problem most brands ignore.</h3>
              <p class="font-body text-sm text-brand-text/60 leading-relaxed mb-6 flex-1">Most bamboo brushes advertise themselves as eco but use nylon-bristle alternatives that don't biodegrade. Here's the full picture.</p>
              <a href="/blog-post/" class="font-body text-sm font-medium text-brand-primary hover:underline inline-flex items-center gap-1">Read more <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></a>
            </div>
          </div>

          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col reveal group" style="transition-delay:80ms;">
            <div class="aspect-[4/3] overflow-hidden bg-brand-surface"><img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/v1777841242/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/iter1/prod-cleaner.png" alt="Copper tongue cleaner from Eqo Logiq morning routine" class="w-full h-full object-cover"></div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-lg text-brand-text mb-3 leading-tight">I replaced my entire morning routine with three products. Here's what happened.</h3>
              <p class="font-body text-sm text-brand-text/60 leading-relaxed mb-6 flex-1">Steel bottle, bamboo brush, copper tongue cleaner. That's the whole stack. Two months in, I haven't added anything back.</p>
              <a href="/blog-post/" class="font-body text-sm font-medium text-brand-primary hover:underline inline-flex items-center gap-1">Read more <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></a>
            </div>
          </div>

          <div class="bg-white rounded-2xl overflow-hidden shadow-[0_2px_16px_rgba(34,34,34,0.07)] flex flex-col reveal group" style="transition-delay:160ms;">
            <div class="aspect-[4/3] overflow-hidden bg-brand-surface"><img src="https://static.kite.ai/image/upload/f_auto,q_auto,w_600,c_fill,g_auto/v1777952952/app/2dc6a210-7df1-4cfe-b9c3-d73dbb7d3353/ujtxtyda6cbyz0mqt1pz.png" alt="Eco-friendly product packaging vs plastic alternatives" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"></div>
            <div class="p-6 flex flex-col flex-1">
              <h3 class="font-sans font-bold text-lg text-brand-text mb-3 leading-tight">Why "eco-friendly" has become meaningless and what to look for instead.</h3>
              <p class="font-body text-sm text-brand-text/60 leading-relaxed mb-6 flex-1">Any brand can print "eco-friendly" on a label. Here are the four questions that actually separate real from performance-washing.</p>
              <a href="/blog-post/" class="font-body text-sm font-medium text-brand-primary hover:underline inline-flex items-center gap-1">Read more <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></a>
            </div>
          </div>
    ...
    <!-- Internal link: Qrash Qourse -->
    <section class="bg-brand-base py-10 border-t border-brand-text/8">
      <div class="max-w-[1400px] mx-auto px-6 md:px-12 text-center">
        <p class="font-body text-brand-text/60 text-sm">Want the full science behind plastic-free living? Read the <a href="/qrash-qourse/" class="text-brand-primary font-medium hover:underline">Qrash Qourse</a>.</p>
      </div>
    </section>
  </main>
