        ...
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-12 ${isHome ? 'mb-24' : 'mb-20'}`}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/shop/?filter=bottles" className="font-body text-white/50 hover:text-white transition-colors">
                  Steel Bottles
                </Link>
              </li>
              <li>
                <Link href="/shop/?filter=oral" className="font-body text-white/50 hover:text-white transition-colors">
                  Oral Care
                </Link>
              </li>
              <li>
                <Link href="/shop/?filter=bundles" className="font-body text-white/50 hover:text-white transition-colors">
                  Bundles
                </Link>
              </li>
              <li>
