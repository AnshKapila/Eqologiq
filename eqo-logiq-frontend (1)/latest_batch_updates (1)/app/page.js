      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pb-24 md:pb-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch">
          ...
          <div className="relative overflow-hidden rounded-2xl reveal" style={{minHeight: 480, background: '#0D1F0E'}}>
            <Image src="/images/feature-lifestyle.jpg" alt="Eqo Logiq steel bottle in daily use" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover opacity-30 scale-125 object-right" />
